...
import sys
sys.path.append('..')
from helper_functions.Preconditioning import Precondition_output, Create_P
...
class Loss_PDE(nn.Module):
    ...
    def forward(self,input,output):
        ...
        loss_pde, loss_boundary=self.loss(input=input,output=output)
...
class Poisson_loss(nn.Module):
      ...
      def forward(self,input,output): 
           ...
           loss_pde = self.loss(-Laplace_u[...,:self.original_input_size,:self.original_input_size],input)
